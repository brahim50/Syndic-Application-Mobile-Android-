...
public class UpdateAppartementActivity extends AppCompatActivity {
    ...
    private String updateUrl = "http://192.168.56.1:8000/api/appartements/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_appartement);

        lmmeuble = findViewById(R.id.lmmeuble);
        etage = findViewById(R.id.etage);
        numero = findViewById(R.id.numero);
        surface = findViewById(R.id.surface);
        delete = findViewById(R.id.deleteAppartement);
        updateAppBtn = findViewById(R.id.updateAppBtn);
        Bundle extras = getIntent().getExtras();
        if (extras != null) {
            this.appartement_id = Integer.parseInt(extras.getString("id"));
            ...
            int surfaceD = Integer.parseInt(extras.getString("surface"));

            lmmeuble.setText(lmmeubleD + "");
            etage.setText(etageD + "");
            numero.setText(numeroD + "");
            surface.setText(surfaceD + "");
        }
    ...
    private void update() {
        ...
        StringRequest request = new StringRequest(Request.Method.PUT,
                updateUrl + appartement_id, new Response.Listener<String>() {
            @Override
